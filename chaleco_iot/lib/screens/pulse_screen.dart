...
class _PulseScreenState extends State<PulseScreen> {
  ...
  void _sendNotification(int pulse) {
    String reason = (pulse > 3000)
        ? "subida brusca (posible desconexión o sensor mal colocado)"
        : "bajada brusca (posible batería baja o sensor desconectado)";
    AwesomeNotifications().createNotification(
      content: NotificationContent(
        id: DateTime.now().millisecondsSinceEpoch.remainder(100000),
        channelKey: 'chaleco_channel',
        title: '⚠️ ALERTA DE PULSO',
        body:
            'Valor detectado: $pulse (raw)\n'
            'Posible problema: $reason',
      ),
    );
  }
            ...
            if (_isRegulating)
              const Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text(
                    "Contacto directo con pecho - Esperando estabilización (1-3 min)",
